...
#pragma HLS DEPENDENCE variable = iPre inter false
        ...
        TrotterUnit2<0>(nTrot, nSpin, ctlStep, iPre[0], j, startStep[0],
        ...
        TrotterUnit2<1>(nTrot, nSpin, ctlStep, iPre[1], j, startStep[1],
        ...
        TrotterUnit2<2>(nTrot, nSpin, ctlStep, iPre[2], j, startStep[2],
        ...
        TrotterUnit2<3>(nTrot, nSpin, ctlStep, iPre[3], j, startStep[3],
...
#pragma HLS DEPENDENCE variable = iPre inter false
            int  i     = iPre[t];
            fp_t hNext = (i != nSpin - 1) ? h[i + 1] : 0.0f;
            TrotterUnit2(nTrot, nSpin, ctlStep, t, i, j, startStep[t],
                         endStep[t], trotters[t], up_trotter[t],
                         down_trotter[t], dH[t], hNext, Beta, dHTunnel,
                         logRandNumber[t], JcoupLocal[t]);
        }
#endif
