...
void TrotterUnit(
...
#else
    fp_pack_t
        JcoupLoaclNextReg[MAX_NSPIN / PACKET_SIZE], /* Jcoup For Next Trotter */
#endif
    ...
    JcoupLoaclNextReg[JcoupCount] = JcoupLocal[JcoupCount];
...
#pragma HLS ARRAY_PARTITION dim = 1 type = complete variable = JcoupLocal
    fp_pack_t JcoupLoaclNextReg[MAX_NTROT][MAX_NSPIN / PACKET_SIZE];
    ;
...
#pragma HLS UNROLL
        ...
        if (stage < MAX_NSPIN) {
        READ_NEW_JCOUP:
            for (u32_t JcoupCount = 0; JcoupCount < MAX_NSPIN / PACKET_SIZE;
                 JcoupCount++) {
...
#pragma HLS UNROLL
                ...
                //#pragma HLS DEPENDENCE variable = JcoupLoaclNextReg inter
                // false #pragma HLS DEPENDENCE variable = upSpin inter false
                //#pragma HLS DEPENDENCE variable = downSpin inter false
                ...
                TU::TrotterUnit(t, stage, step, iPrePack[t], iPreSpin[t],
                                ...
                                JcoupLocal[t], JcoupLoaclNextReg[t], JcoupCount,
...
#pragma HLS UNROLL
                JcoupLocal[t + 1][JcoupCount] =
                    JcoupLoaclNextReg[t][JcoupCount];
            }
        }
    }
}
