...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.96([4096 x [256 x i512]]* %3, [4096 x [256 x %struct.fp_pack_t]]* %2)
...
entry:
  call fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint.90([4 x [256 x %struct.ap_uint]]* %0, [4 x [256 x i16]]* align 512 %1)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint.90([4 x [256 x %struct.ap_uint]]* noalias, [4 x [256 x i16]]* noalias readonly align 512) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.96([4096 x [256 x i512]]* noalias, [4096 x [256 x %struct.fp_pack_t]]* noalias readonly) unnamed_addr #2 {
entry:
