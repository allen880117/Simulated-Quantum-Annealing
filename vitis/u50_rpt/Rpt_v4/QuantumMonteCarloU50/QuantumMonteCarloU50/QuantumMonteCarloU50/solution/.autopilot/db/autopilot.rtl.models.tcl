set SynModuleInfo {
  {SRCNAME QuantumMonteCarloU50_Pipeline_READ_TROTTERS_VITIS_LOOP_195_1 MODELNAME QuantumMonteCarloU50_Pipeline_READ_TROTTERS_VITIS_LOOP_195_1 RTLNAME QuantumMonteCarloU50_QuantumMonteCarloU50_Pipeline_READ_TROTTERS_VITIS_LOOP_195_1
    SUBMODULES {
  ...
  {SRCNAME QuantumMonteCarloU50_Pipeline_WRITE_TROTTERS_VITIS_LOOP_281_3 MODELNAME QuantumMonteCarloU50_Pipeline_WRITE_TROTTERS_VITIS_LOOP_281_3 RTLNAME QuantumMonteCarloU50_QuantumMonteCarloU50_Pipeline_WRITE_TROTTERS_VITIS_LOOP_281_3
    SUBMODULES {
      {MODELNAME QuantumMonteCarloU50_mux_42_16_1_1 RTLNAME QuantumMonteCarloU50_mux_42_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME QuantumMonteCarloU50 MODELNAME QuantumMonteCarloU50 RTLNAME QuantumMonteCarloU50 IS_TOP 1
    SUBMODULES {
      {MODELNAME QuantumMonteCarloU50_trottersLocal_V_0 RTLNAME QuantumMonteCarloU50_trottersLocal_V_0 BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME QuantumMonteCarloU50_JcoupLocal_0 RTLNAME QuantumMonteCarloU50_JcoupLocal_0 BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME QuantumMonteCarloU50_JcoupLocal_1 RTLNAME QuantumMonteCarloU50_JcoupLocal_1 BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
