set moduleName QuantumMonteCarloU50_Pipeline_WRITE_TROTTERS_VITIS_LOOP_281_3
set isTopModule 0
...
set C_modelName {QuantumMonteCarloU50_Pipeline_WRITE_TROTTERS_VITIS_LOOP_281_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 512 regular {axi_master 1}  }
	{ sext_ln194 int 58 regular  }
	{ trottersLocal_V_0 int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ trottersLocal_V_1 int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ trottersLocal_V_2 int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ trottersLocal_V_3 int 16 regular {array 256 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "trotters","offset": { "type": "dynamic","port_name": "trotters","bundle": "control"},"direction": "READWRITE"},{"cName": "Jcoup","offset": { "type": "dynamic","port_name": "Jcoup","bundle": "control"},"direction": "READONLY"},{"cName": "h","offset": { "type": "dynamic","port_name": "h","bundle": "control"},"direction": "READONLY"},{"cName": "logRand","offset": { "type": "dynamic","port_name": "logRand","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "trottersLocal_V_0", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "trottersLocal_V_1", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "trottersLocal_V_2", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "trottersLocal_V_3", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trottersLocal_V_0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trottersLocal_V_0", "role": "q0" }} , 
 	...
 	{ "name": "trottersLocal_V_1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trottersLocal_V_1", "role": "q0" }} , 
 	...
 	{ "name": "trottersLocal_V_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trottersLocal_V_2", "role": "q0" }} , 
 	...
 	{ "name": "trottersLocal_V_3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trottersLocal_V_3", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_16_1_1_U107", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	trottersLocal_V_0 { ap_memory {  { trottersLocal_V_0_address0 mem_address 1 8 }  { trottersLocal_V_0_ce0 mem_ce 1 1 }  { trottersLocal_V_0_q0 mem_dout 0 16 } } }
	trottersLocal_V_1 { ap_memory {  { trottersLocal_V_1_address0 mem_address 1 8 }  { trottersLocal_V_1_ce0 mem_ce 1 1 }  { trottersLocal_V_1_q0 mem_dout 0 16 } } }
	trottersLocal_V_2 { ap_memory {  { trottersLocal_V_2_address0 mem_address 1 8 }  { trottersLocal_V_2_ce0 mem_ce 1 1 }  { trottersLocal_V_2_q0 mem_dout 0 16 } } }
	trottersLocal_V_3 { ap_memory {  { trottersLocal_V_3_address0 mem_address 1 8 }  { trottersLocal_V_3_ce0 mem_ce 1 1 }  { trottersLocal_V_3_q0 mem_dout 0 16 } } }
}
