...
// wrapc file define:
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvout_gmem0.dat"
// wrapc file define:
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvin_gmem1.dat"
#define AUTOTB_TVOUT_gmem1 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvout_gmem1.dat"
// wrapc file define:
#define AUTOTB_TVIN_gmem2 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvin_gmem2.dat"
#define AUTOTB_TVOUT_gmem2 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvout_gmem2.dat"
// wrapc file define:
#define AUTOTB_TVIN_gmem3 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvin_gmem3.dat"
#define AUTOTB_TVOUT_gmem3 "../tv/cdatafile/c.QuantumMonteCarloU50.autotvout_gmem3.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.QuantumMonteCarloU50.autotvout_gmem0.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.QuantumMonteCarloU50.autotvout_gmem1.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem2 "../tv/rtldatafile/rtl.QuantumMonteCarloU50.autotvout_gmem2.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem3 "../tv/rtldatafile/rtl.QuantumMonteCarloU50.autotvout_gmem3.dat"
// tvout file define:
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<512> > gmem0_pc_buffer(32);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 32; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_trotters)[j*8+0] = gmem0_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+1] = gmem0_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+2] = gmem0_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+3] = gmem0_pc_buffer[i].range(255,192).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+4] = gmem0_pc_buffer[i].range(319,256).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+5] = gmem0_pc_buffer[i].range(383,320).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+6] = gmem0_pc_buffer[i].range(447,384).to_int64();
((long long*)__xlx_apatb_param_trotters)[j*8+7] = gmem0_pc_buffer[i].range(511,448).to_int64();
}}}
        } // end transaction
      } // end file is good
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_trotters)[j*8+7];
  ...
  tcl_file.set_num(32, &tcl_file.gmem0_depth);
...
// print gmem1 Transactions
{
  ...
  {  __xlx_offset_byte_param_Jcoup = 0*64;
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_Jcoup)[j*8+7];
  ...
  tcl_file.set_num(1048576, &tcl_file.gmem1_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_gmem1, __xlx_sprintf_buffer.data());
}
...
// print gmem2 Transactions
{
  ...
  {  __xlx_offset_byte_param_h = 0*64;
...
// print gmem3 Transactions
{
  ...
  {  __xlx_offset_byte_param_logRand = 0*64;
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_logRand)[j*8+7];
  ...
  tcl_file.set_num(1024, &tcl_file.gmem3_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_gmem3, __xlx_sprintf_buffer.data());
}
