...
define void @apatb_QuantumMonteCarloU50_ir([256 x %struct.ap_uint]* %trotters, [256 x %struct.fp_pack_t]* %Jcoup, float* %h, float %Jperp, float %Beta, [4096 x float]* %logRand) local_unnamed_addr #0 {
entry:
  %trotters_copy = alloca [4 x [256 x i16]], align 512
  ...
  %0 = bitcast [256 x %struct.ap_uint]* %trotters to [4 x [256 x %struct.ap_uint]]*
  ...
  call fastcc void @copy_in([4 x [256 x %struct.ap_uint]]* %0, [4 x [256 x i16]]* nonnull align 512 %trotters_copy, [4096 x [256 x %struct.fp_pack_t]]* %1, [4096 x [256 x i512]]* %Jcoup_copy, [4096 x float]* %2, [4096 x float]* %h_copy, [4 x [4096 x float]]* %3, [4 x [4096 x float]]* %logRand_copy)
  %4 = getelementptr [4 x [256 x i16]], [4 x [256 x i16]]* %trotters_copy, i32 0, i32 0
  %5 = getelementptr [4096 x [256 x i512]], [4096 x [256 x i512]]* %Jcoup_copy, i32 0, i32 0
  %6 = getelementptr inbounds [4096 x float], [4096 x float]* %h_copy, i32 0, i32 0
  %7 = getelementptr inbounds [4 x [4096 x float]], [4 x [4096 x float]]* %logRand_copy, i32 0, i32 0
  call void @apatb_QuantumMonteCarloU50_hw([256 x i16]* %4, [256 x i512]* %5, float* %6, float %Jperp, float %Beta, [4096 x float]* %7)
  call fastcc void @copy_out([4 x [256 x %struct.ap_uint]]* %0, [4 x [256 x i16]]* nonnull align 512 %trotters_copy, [4096 x [256 x %struct.fp_pack_t]]* %1, [4096 x [256 x i512]]* %Jcoup_copy, [4096 x float]* %2, [4096 x float]* %h_copy, [4 x [4096 x float]]* %3, [4 x [4096 x float]]* %logRand_copy)
...
define internal fastcc void @copy_in([4 x [256 x %struct.ap_uint]]* readonly, [4 x [256 x i16]]* noalias align 512, [4096 x [256 x %struct.fp_pack_t]]* readonly, [4096 x [256 x i512]]* noalias, [4096 x float]* readonly, [4096 x float]* noalias, [4 x [4096 x float]]* readonly, [4 x [4096 x float]]* noalias) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint([4 x [256 x i16]]* align 512 %1, [4 x [256 x %struct.ap_uint]]* %0)
  call fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.20([4096 x [256 x i512]]* %3, [4096 x [256 x %struct.fp_pack_t]]* %2)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint([4 x [256 x i16]]* noalias align 512, [4 x [256 x %struct.ap_uint]]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [4 x [256 x i16]]* %0, null
  %3 = icmp eq [4 x [256 x %struct.ap_uint]]* %1, null
  %4 = or i1 %2, %3
...
for.loop2:                                        ; preds = %for.loop2, %for.loop
  ...
  %5 = getelementptr [4 x [256 x i16]], [4 x [256 x i16]]* %0, i64 0, i64 %for.loop.idx18, i64 %for.loop.idx317
  %src.addr6.0.0.013.gep16 = getelementptr [4 x [256 x %struct.ap_uint]], [4 x [256 x %struct.ap_uint]]* %1, i64 0, i64 %for.loop.idx18, i64 %for.loop.idx317, i32 0, i32 0, i32 0
  %6 = load i16, i16* %src.addr6.0.0.013.gep16, align 2
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t([4096 x [256 x %struct.fp_pack_t]]* noalias, [4096 x [256 x i512]]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a4096f32([4 x [4096 x float]]* noalias, [4 x [4096 x float]]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([4 x [256 x %struct.ap_uint]]*, [4 x [256 x i16]]* noalias readonly align 512, [4096 x [256 x %struct.fp_pack_t]]*, [4096 x [256 x i512]]* noalias readonly, [4096 x float]*, [4096 x float]* noalias readonly, [4 x [4096 x float]]*, [4 x [4096 x float]]* noalias readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint.14([4 x [256 x %struct.ap_uint]]* %0, [4 x [256 x i16]]* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t([4096 x [256 x %struct.fp_pack_t]]* %2, [4096 x [256 x i512]]* %3)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint.14([4 x [256 x %struct.ap_uint]]* noalias, [4 x [256 x i16]]* noalias readonly align 512) unnamed_addr #2 {
entry:
  %2 = icmp eq [4 x [256 x %struct.ap_uint]]* %0, null
  %3 = icmp eq [4 x [256 x i16]]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop2:                                        ; preds = %for.loop2, %for.loop
  %for.loop.idx317 = phi i64 [ 0, %for.loop ], [ %for.loop.idx3.next, %for.loop2 ]
  %dst.addr5.0.0.014.gep15 = getelementptr [4 x [256 x %struct.ap_uint]], [4 x [256 x %struct.ap_uint]]* %0, i64 0, i64 %for.loop.idx18, i64 %for.loop.idx317, i32 0, i32 0, i32 0
  %5 = getelementptr [4 x [256 x i16]], [4 x [256 x i16]]* %1, i64 0, i64 %for.loop.idx18, i64 %for.loop.idx317
  %6 = load i16, i16* %5, align 2
  store i16 %6, i16* %dst.addr5.0.0.014.gep15, align 2
  %for.loop.idx3.next = add nuw nsw i64 %for.loop.idx317, 1
  %exitcond = icmp ne i64 %for.loop.idx3.next, 256
  br i1 %exitcond, label %for.loop2, label %for.loop.split
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.20([4096 x [256 x i512]]* noalias, [4096 x [256 x %struct.fp_pack_t]]* noalias readonly) unnamed_addr #2 {
entry:
...
declare void @apatb_QuantumMonteCarloU50_hw([256 x i16]*, [256 x i512]*, float*, float, float, [4096 x float]*)

define void @QuantumMonteCarloU50_hw_stub_wrapper([256 x i16]*, [256 x i512]*, float*, float, float, [4096 x float]*) #6 {
entry:
  %6 = alloca [4 x [256 x %struct.ap_uint]]
  %malloccall = tail call i8* @malloc(i64 67108864)
  %7 = bitcast i8* %malloccall to [4096 x [256 x %struct.fp_pack_t]]*
  %8 = bitcast [256 x i16]* %0 to [4 x [256 x i16]]*
  %9 = bitcast [256 x i512]* %1 to [4096 x [256 x i512]]*
  %10 = bitcast float* %2 to [4096 x float]*
  %11 = bitcast [4096 x float]* %5 to [4 x [4096 x float]]*
  call void @copy_out([4 x [256 x %struct.ap_uint]]* %6, [4 x [256 x i16]]* %8, [4096 x [256 x %struct.fp_pack_t]]* %7, [4096 x [256 x i512]]* %9, [4096 x float]* null, [4096 x float]* %10, [4 x [4096 x float]]* null, [4 x [4096 x float]]* %11)
  %12 = bitcast [4 x [256 x %struct.ap_uint]]* %6 to [256 x %struct.ap_uint]*
  %13 = bitcast [4096 x [256 x %struct.fp_pack_t]]* %7 to [256 x %struct.fp_pack_t]*
  %14 = bitcast [4096 x float]* %10 to float*
  %15 = bitcast [4 x [4096 x float]]* %11 to [4096 x float]*
  call void @QuantumMonteCarloU50_hw_stub([256 x %struct.ap_uint]* %12, [256 x %struct.fp_pack_t]* %13, float* %14, float %3, float %4, [4096 x float]* %15)
  call void @copy_in([4 x [256 x %struct.ap_uint]]* %6, [4 x [256 x i16]]* %8, [4096 x [256 x %struct.fp_pack_t]]* %7, [4096 x [256 x i512]]* %9, [4096 x float]* null, [4096 x float]* %10, [4 x [4096 x float]]* null, [4 x [4096 x float]]* %11)
  ret void
}

declare void @QuantumMonteCarloU50_hw_stub([256 x %struct.ap_uint]*, [256 x %struct.fp_pack_t]*, float*, float, float, [4096 x float]*)
