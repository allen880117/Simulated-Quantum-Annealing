...
set C_modelArgList {
	{ add_ln228 int 64 regular  }
	{ sext_ln246 int 58 regular  }
	{ gmem1 int 512 regular {axi_master 0}  }
	{ JcoupLocal_0 int 16384 regular {array 8 { 3 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln228", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln246", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "JcoupLocal_0", "interface" : "memory", "bitwidth" : 16384, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add_ln228 sc_in sc_lv 64 signal 0 } 
	{ sext_ln246 sc_in sc_lv 58 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln228", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add_ln228", "role": "default" }} , 
 	{ "name": "sext_ln246", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln246", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "add_ln228", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	QuantumMonteCarloU50_Pipeline_READ_NEW_JCOUP {
		add_ln228 {Type I LastRead 0 FirstWrite -1}
		sext_ln246 {Type I LastRead 0 FirstWrite -1}
		gmem1 {Type I LastRead 134 FirstWrite -1}
		JcoupLocal_0 {Type O LastRead -1 FirstWrite 135}}}
...
set Spec2ImplPortList { 
	add_ln228 { ap_none {  { add_ln228 in_data 0 64 } } }
	sext_ln246 { ap_none {  { sext_ln246 in_data 0 58 } } }
	...
	JcoupLocal_0 { ap_memory {  { JcoupLocal_0_address1 MemPortADDR2 1 3 }  { JcoupLocal_0_ce1 MemPortCE2 1 1 }  { JcoupLocal_0_we1 MemPortWE2 1 1 }  { JcoupLocal_0_d1 MemPortDIN2 1 16384 } } }
}
