...
set Library     "hls"
set IPName      "QuantumMonteCarloU50"
set Version     "1.0"
set DisplayName "Quantummontecarlou50"
set Revision    "2108241100"
...
set xo_kernel_name "QuantumMonteCarloU50"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/edci/workspace/SQA_kernels/Hardware/build/QuantumMonteCarloU50/QuantumMonteCarloU50/QuantumMonteCarloU50/solution"
set debug_dir "/home/edci/workspace/SQA_kernels/Hardware/build/QuantumMonteCarloU50/QuantumMonteCarloU50/QuantumMonteCarloU50/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {QuantumMonteCarloU50_flow_control_loop_pipe_sequential_init
...
QuantumMonteCarloU50_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "QuantumMonteCarloU50"
set TopNoPrefix "QuantumMonteCarloU50"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 trotters_1 W 0x0 "Data signal of trotters" {{0 32 trotters W 0 "Bit 31 to 0 of trotters"}}} {0x14 trotters_2 W 0x0 "Data signal of trotters" {{0 32 trotters W 0 "Bit 63 to 32 of trotters"}}} {0x1c Jcoup_1 W 0x0 "Data signal of Jcoup" {{0 32 Jcoup W 0 "Bit 31 to 0 of Jcoup"}}} {0x20 Jcoup_2 W 0x0 "Data signal of Jcoup" {{0 32 Jcoup W 0 "Bit 63 to 32 of Jcoup"}}} {0x28 h_1 W 0x0 "Data signal of h" {{0 32 h W 0 "Bit 31 to 0 of h"}}} {0x2c h_2 W 0x0 "Data signal of h" {{0 32 h W 0 "Bit 63 to 32 of h"}}} {0x34 Jperp W 0x0 "Data signal of Jperp" {{0 32 Jperp W 0 "Bit 31 to 0 of Jperp"}}} {0x3c Beta W 0x0 "Data signal of Beta" {{0 32 Beta W 0 "Bit 31 to 0 of Beta"}}} {0x44 logRand_1 W 0x0 "Data signal of logRand" {{0 32 logRand W 0 "Bit 31 to 0 of logRand"}}} {0x48 logRand_2 W 0x0 "Data signal of logRand" {{0 32 logRand W 0 "Bit 63 to 32 of logRand"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.333 machine 64 combinational 0 latency 467499 II x}
...
source -notrace "/home/edci/Xilinx/Vitis_HLS/2021.1/common/scripts/ipxhls.tcl"
