...
entry:
  call fastcc void @onebyonecpy_hls.p0a4a8struct.ap_uint.97([4 x [8 x i512]]* align 512 %1, [4 x [8 x %struct.ap_uint]]* %0)
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.91([4096 x [256 x %struct.fp_pack_t]]* %2, [4096 x [256 x i512]]* %3)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.91([4096 x [256 x %struct.fp_pack_t]]* noalias, [4096 x [256 x i512]]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a8struct.ap_uint.97([4 x [8 x i512]]* noalias align 512 "fpga.caller.interfaces"="layout_transformed", [4 x [8 x %struct.ap_uint]]* noalias readonly "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
