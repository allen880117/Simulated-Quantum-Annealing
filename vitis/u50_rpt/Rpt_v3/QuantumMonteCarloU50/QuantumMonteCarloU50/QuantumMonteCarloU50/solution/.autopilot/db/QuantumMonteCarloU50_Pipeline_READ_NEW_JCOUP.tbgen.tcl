...
set C_modelArgList {
	...
	{ sext_ln241 int 58 regular  }
	{ JcoupLocal_0 int 512 regular {array 256 { 3 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "Jcoup","offset": { "type": "dynamic","port_name": "Jcoup","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln241", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "JcoupLocal_0", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln241 sc_in sc_lv 58 signal 1 } 
	{ JcoupLocal_0_address1 sc_out sc_lv 8 signal 2 } 
	{ JcoupLocal_0_ce1 sc_out sc_logic 1 signal 2 } 
	{ JcoupLocal_0_we1 sc_out sc_logic 1 signal 2 } 
	{ JcoupLocal_0_d1 sc_out sc_lv 512 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln241", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln241", "role": "default" }} , 
 	{ "name": "JcoupLocal_0_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "JcoupLocal_0", "role": "address1" }} , 
 	...
 	{ "name": "JcoupLocal_0_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "JcoupLocal_0", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln241 { ap_none {  { sext_ln241 in_data 0 58 } } }
	JcoupLocal_0 { ap_memory {  { JcoupLocal_0_address1 MemPortADDR2 1 8 }  { JcoupLocal_0_ce1 MemPortCE2 1 1 }  { JcoupLocal_0_we1 MemPortWE2 1 1 }  { JcoupLocal_0_d1 MemPortDIN2 1 512 } } }
}
