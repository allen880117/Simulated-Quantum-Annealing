...
entry:
  ...
  call void @apatb_QuantumMonteCarloU50_hw([4 x [256 x i16]]* %trotters_copy, [256 x i512]* %4, float* %5, float %Jperp, float %Beta, [4 x [4096 x float]]* %logRand_copy)
...
define internal fastcc void @copy_in([4 x [256 x %struct.ap_uint]]* readonly, [4 x [256 x i16]]* noalias align 512 "fpga.caller.interfaces"="layout_transformed", [4096 x [256 x %struct.fp_pack_t]]* readonly, [4096 x [256 x i512]]* noalias, [4096 x float]* readonly, [4096 x float]* noalias, [4 x [4096 x float]]* readonly, [4 x [4096 x float]]* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint([4 x [256 x i16]]* align 512 %1, [4 x [256 x %struct.ap_uint]]* %0)
  call fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.97([4096 x [256 x i512]]* %3, [4096 x [256 x %struct.fp_pack_t]]* %2)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint([4 x [256 x i16]]* noalias align 512 "fpga.caller.interfaces"="layout_transformed", [4 x [256 x %struct.ap_uint]]* noalias readonly "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([4 x [256 x %struct.ap_uint]]*, [4 x [256 x i16]]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed", [4096 x [256 x %struct.fp_pack_t]]*, [4096 x [256 x i512]]* noalias readonly, [4096 x float]*, [4096 x float]* noalias readonly, [4 x [4096 x float]]*, [4 x [4096 x float]]* noalias readonly "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint.91([4 x [256 x %struct.ap_uint]]* %0, [4 x [256 x i16]]* align 512 %1)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4a256struct.ap_uint.91([4 x [256 x %struct.ap_uint]]* noalias "fpga.caller.interfaces"="layout_transformed", [4 x [256 x i16]]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4096a256struct.fp_pack_t.97([4096 x [256 x i512]]* noalias, [4096 x [256 x %struct.fp_pack_t]]* noalias readonly) unnamed_addr #2 {
entry:
...
declare void @apatb_QuantumMonteCarloU50_hw([4 x [256 x i16]]*, [256 x i512]*, float*, float, float, [4 x [4096 x float]]*)

define void @QuantumMonteCarloU50_hw_stub_wrapper([4 x [256 x i16]]*, [256 x i512]*, float*, float, float, [4 x [4096 x float]]*) #6 {
entry:
  ...
  call void @copy_out([4 x [256 x %struct.ap_uint]]* %6, [4 x [256 x i16]]* %0, [4096 x [256 x %struct.fp_pack_t]]* %7, [4096 x [256 x i512]]* %8, [4096 x float]* null, [4096 x float]* %9, [4 x [4096 x float]]* null, [4 x [4096 x float]]* %5)
  %10 = bitcast [4 x [256 x %struct.ap_uint]]* %6 to [256 x %struct.ap_uint]*
  ...
  call void @QuantumMonteCarloU50_hw_stub([256 x %struct.ap_uint]* %10, [256 x %struct.fp_pack_t]* %11, float* %12, float %3, float %4, [4096 x float]* %13)
  call void @copy_in([4 x [256 x %struct.ap_uint]]* %6, [4 x [256 x i16]]* %0, [4096 x [256 x %struct.fp_pack_t]]* %7, [4096 x [256 x i512]]* %8, [4096 x float]* null, [4096 x float]* %9, [4 x [4096 x float]]* null, [4 x [4096 x float]]* %5)
  ret void
}
