...
wire   [0:0] icmp_ln135_fu_622_p2;
reg   [0:0] icmp_ln135_reg_857;
wire   [0:0] icmp_ln135_1_fu_628_p2;
reg   [0:0] icmp_ln135_1_reg_862;
wire   [0:0] icmp_ln135_2_fu_634_p2;
reg   [0:0] icmp_ln135_2_reg_867;
wire   [0:0] icmp_ln135_3_fu_640_p2;
reg   [0:0] icmp_ln135_3_reg_872;
wire   [0:0] and_ln135_1_fu_660_p2;
reg   [0:0] and_ln135_1_reg_877;
...
wire   [0:0] icmp_ln110_fu_423_p2;
wire   [12:0] or_ln_fu_435_p3;
wire   [0:0] xor_ln110_fu_429_p2;
wire   [0:0] icmp_ln110_1_fu_443_p2;
wire   [0:0] xor_ln1049_1_fu_461_p2;
wire   [0:0] and_ln121_fu_466_p2;
wire   [31:0] select_ln121_fu_471_p3;
wire   [3:0] lshr_ln_fu_486_p4;
wire   [63:0] p_Val2_s_fu_518_p17;
wire   [15:0] trunc_ln819_1_fu_556_p1;
wire   [31:0] bitcast_ln131_fu_567_p1;
wire   [31:0] xor_ln131_fu_570_p2;
wire   [31:0] bitcast_ln131_1_fu_576_p1;
wire   [31:0] bitcast_ln135_fu_587_p1;
wire   [31:0] bitcast_ln135_1_fu_605_p1;
wire   [7:0] tmp_fu_591_p4;
wire   [22:0] trunc_ln135_fu_601_p1;
wire   [7:0] tmp_1_fu_608_p4;
wire   [22:0] trunc_ln135_1_fu_618_p1;
wire   [0:0] or_ln135_fu_646_p2;
wire   [0:0] or_ln135_1_fu_650_p2;
wire   [0:0] and_ln135_fu_654_p2;
...
QuantumMonteCarloU50_fsub_32ns_32ns_32_7_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_7_full_dsp_1_U485(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(dH),
    .din1(dHTunnel),
...
QuantumMonteCarloU50_fdiv_32ns_32ns_32_12_no_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fdiv_32ns_32ns_32_12_no_dsp_1_U488(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(logRandNumber),
    .din1(Beta),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state15) & (1'd1 == and_ln135_1_fu_660_p2))) begin
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd10) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters10_we0 = 1'b1;
    end else begin
        trotters10_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd11) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters11_we0 = 1'b1;
    end else begin
        trotters11_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd12) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters12_we0 = 1'b1;
    end else begin
        trotters12_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd13) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters13_we0 = 1'b1;
    end else begin
        trotters13_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd14) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters14_we0 = 1'b1;
    end else begin
        trotters14_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd15) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters15_we0 = 1'b1;
    end else begin
        trotters15_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd1) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters1_we0 = 1'b1;
    end else begin
        trotters1_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd2) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters2_we0 = 1'b1;
    end else begin
        trotters2_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd3) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters3_we0 = 1'b1;
    end else begin
        trotters3_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd4) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters4_we0 = 1'b1;
    end else begin
        trotters4_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd5) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters5_we0 = 1'b1;
    end else begin
        trotters5_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd6) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters6_we0 = 1'b1;
    end else begin
        trotters6_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd7) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters7_we0 = 1'b1;
    end else begin
        trotters7_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd8) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters8_we0 = 1'b1;
    end else begin
        trotters8_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd9) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters9_we0 = 1'b1;
    end else begin
        trotters9_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln819_reg_744 == 4'd0) & (1'b1 == ap_CS_fsm_state16) & (1'd1 == and_ln135_1_reg_877) & (inside_reg_719 == 1'd1))) begin
        trotters_we0 = 1'b1;
    end else begin
        trotters_we0 = 1'b0;
    end
...
assign and_ln121_fu_466_p2 = (xor_ln1049_1_fu_461_p2 & upSpin);

assign and_ln135_1_fu_660_p2 = (grp_fu_415_p2 & and_ln135_fu_654_p2);

assign and_ln135_fu_654_p2 = (or_ln135_fu_646_p2 & or_ln135_1_fu_650_p2);
...
assign bitcast_ln131_1_fu_576_p1 = xor_ln131_fu_570_p2;

assign bitcast_ln131_fu_567_p1 = dHTmp_reg_846;

assign bitcast_ln135_1_fu_605_p1 = div_reg_829;

assign bitcast_ln135_fu_587_p1 = dHTmp_1_fu_580_p3;

assign dHTmp_1_fu_580_p3 = ((p_Result_1_reg_840[0:0] == 1'b1) ? bitcast_ln131_1_fu_576_p1 : dHTmp_reg_846);

assign icmp_ln110_1_fu_443_p2 = ((or_ln_fu_435_p3 > stage) ? 1'b1 : 1'b0);

assign icmp_ln110_fu_423_p2 = ((stage < t_offset_cast_fu_419_p1) ? 1'b1 : 1'b0);

assign icmp_ln135_1_fu_628_p2 = ((trunc_ln135_fu_601_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln135_2_fu_634_p2 = ((tmp_1_fu_608_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln135_3_fu_640_p2 = ((trunc_ln135_1_fu_618_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln135_fu_622_p2 = ((tmp_fu_591_p4 != 8'd255) ? 1'b1 : 1'b0);

assign inside_fu_449_p2 = (xor_ln110_fu_429_p2 & icmp_ln110_1_fu_443_p2);

assign lshr_ln_fu_486_p4 = {{iPack[7:4]}};

assign or_ln135_1_fu_650_p2 = (icmp_ln135_3_reg_872 | icmp_ln135_2_reg_867);

assign or_ln135_fu_646_p2 = (icmp_ln135_reg_857 | icmp_ln135_1_reg_862);
...
assign select_ln1049_fu_477_p3 = ((xor_ln1049_reg_723[0:0] == 1'b1) ? dH : select_ln121_fu_471_p3);

assign select_ln121_fu_471_p3 = ((and_ln121_fu_466_p2[0:0] == 1'b1) ? sub_reg_729 : add4_reg_734);

assign t_offset_cast_fu_419_p1 = t_offset;

assign tmp_1_fu_608_p4 = {{bitcast_ln135_1_fu_605_p1[30:23]}};

assign tmp_fu_591_p4 = {{bitcast_ln135_fu_587_p1[30:23]}};
...
assign trunc_ln135_1_fu_618_p1 = bitcast_ln135_1_fu_605_p1[22:0];

assign trunc_ln135_fu_601_p1 = bitcast_ln135_fu_587_p1[22:0];
...
assign xor_ln110_fu_429_p2 = (icmp_ln110_fu_423_p2 ^ 1'd1);

assign xor_ln131_fu_570_p2 = (bitcast_ln131_fu_567_p1 ^ 32'd2147483648);
