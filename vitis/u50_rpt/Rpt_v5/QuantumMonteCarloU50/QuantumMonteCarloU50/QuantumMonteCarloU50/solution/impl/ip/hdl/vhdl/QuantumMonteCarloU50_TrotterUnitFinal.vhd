...
attribute shreg_extract : string;
    ...
    signal icmp_ln135_fu_622_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_reg_857 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_1_fu_628_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_1_reg_862 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_2_fu_634_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_2_reg_867 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_3_fu_640_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln135_3_reg_872 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln135_1_fu_660_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln135_1_reg_877 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln110_fu_423_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln_fu_435_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal xor_ln110_fu_429_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln110_1_fu_443_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln1049_1_fu_461_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln121_fu_466_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln121_fu_471_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bitcast_ln131_fu_567_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal xor_ln131_fu_570_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln131_1_fu_576_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln135_fu_587_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln135_1_fu_605_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_fu_591_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln135_fu_601_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_1_fu_608_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln135_1_fu_618_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal or_ln135_fu_646_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln135_1_fu_650_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln135_fu_654_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    fsub_32ns_32ns_32_7_full_dsp_1_U485 : component QuantumMonteCarloU50_fsub_32ns_32ns_32_7_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 7,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_7_full_dsp_1_U486 : component QuantumMonteCarloU50_fadd_32ns_32ns_32_7_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 7,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_4_max_dsp_1_U487 : component QuantumMonteCarloU50_fmul_32ns_32ns_32_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fdiv_32ns_32ns_32_12_no_dsp_1_U488 : component QuantumMonteCarloU50_fdiv_32ns_32ns_32_12_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 12,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U489 : component QuantumMonteCarloU50_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mux_1664_16_1_1_U490 : component QuantumMonteCarloU50_mux_1664_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state15)) then
                and_ln135_1_reg_877 <= and_ln135_1_fu_660_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state14)) then
                icmp_ln135_1_reg_862 <= icmp_ln135_1_fu_628_p2;
                icmp_ln135_2_reg_867 <= icmp_ln135_2_fu_634_p2;
                icmp_ln135_3_reg_872 <= icmp_ln135_3_fu_640_p2;
                icmp_ln135_reg_857 <= icmp_ln135_fu_622_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state15) and (ap_const_lv1_1 = and_ln135_1_fu_660_p2))) then
    ...
    and_ln121_fu_466_p2 <= (xor_ln1049_1_fu_461_p2 and upSpin);
    and_ln135_1_fu_660_p2 <= (grp_fu_415_p2 and and_ln135_fu_654_p2);
    and_ln135_fu_654_p2 <= (or_ln135_fu_646_p2 and or_ln135_1_fu_650_p2);
    ...
    bitcast_ln131_1_fu_576_p1 <= xor_ln131_fu_570_p2;
    bitcast_ln131_fu_567_p1 <= dHTmp_reg_846;
    bitcast_ln135_1_fu_605_p1 <= div_reg_829;
    bitcast_ln135_fu_587_p1 <= dHTmp_1_fu_580_p3;
    dHTmp_1_fu_580_p3 <= 
        bitcast_ln131_1_fu_576_p1 when (p_Result_1_reg_840(0) = '1') else 
        dHTmp_reg_846;
    icmp_ln110_1_fu_443_p2 <= "1" when (unsigned(or_ln_fu_435_p3) > unsigned(stage)) else "0";
    icmp_ln110_fu_423_p2 <= "1" when (unsigned(stage) < unsigned(t_offset_cast_fu_419_p1)) else "0";
    icmp_ln135_1_fu_628_p2 <= "1" when (trunc_ln135_fu_601_p1 = ap_const_lv23_0) else "0";
    icmp_ln135_2_fu_634_p2 <= "0" when (tmp_1_fu_608_p4 = ap_const_lv8_FF) else "1";
    icmp_ln135_3_fu_640_p2 <= "1" when (trunc_ln135_1_fu_618_p1 = ap_const_lv23_0) else "0";
    icmp_ln135_fu_622_p2 <= "0" when (tmp_fu_591_p4 = ap_const_lv8_FF) else "1";
    inside_fu_449_p2 <= (xor_ln110_fu_429_p2 and icmp_ln110_1_fu_443_p2);
    lshr_ln_fu_486_p4 <= iPack(7 downto 4);
    or_ln135_1_fu_650_p2 <= (icmp_ln135_3_reg_872 or icmp_ln135_2_reg_867);
    or_ln135_fu_646_p2 <= (icmp_ln135_reg_857 or icmp_ln135_1_reg_862);
    ...
    select_ln1049_fu_477_p3 <= 
        ...
        select_ln121_fu_471_p3;
    select_ln121_fu_471_p3 <= 
        sub_reg_729 when (and_ln121_fu_466_p2(0) = '1') else 
        add4_reg_734;
    t_offset_cast_fu_419_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_offset),13));
    tmp_1_fu_608_p4 <= bitcast_ln135_1_fu_605_p1(30 downto 23);
    tmp_fu_591_p4 <= bitcast_ln135_fu_587_p1(30 downto 23);
    ...
    trotters10_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_A) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters11_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_B) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters12_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_C) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters13_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_D) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters14_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_E) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters15_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_F) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters1_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_1) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters2_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_2) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters3_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_3) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters4_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_4) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters5_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_5) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters6_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_6) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters7_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_7) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters8_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_8) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters9_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_9) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trotters_we0_assign_proc : process(inside_reg_719, trunc_ln819_reg_744, and_ln135_1_reg_877, ap_CS_fsm_state16)
    begin
        if (((trunc_ln819_reg_744 = ap_const_lv4_0) and (ap_const_logic_1 = ap_CS_fsm_state16) and (ap_const_lv1_1 = and_ln135_1_reg_877) and (inside_reg_719 = ap_const_lv1_1))) then 
    ...
    trunc_ln135_1_fu_618_p1 <= bitcast_ln135_1_fu_605_p1(23 - 1 downto 0);
    trunc_ln135_fu_601_p1 <= bitcast_ln135_fu_587_p1(23 - 1 downto 0);
    ...
    xor_ln110_fu_429_p2 <= (icmp_ln110_fu_423_p2 xor ap_const_lv1_1);
    xor_ln131_fu_570_p2 <= (bitcast_ln131_fu_567_p1 xor ap_const_lv32_80000000);
